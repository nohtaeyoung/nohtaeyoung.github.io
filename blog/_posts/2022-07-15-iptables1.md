...
{: .box-note}
<b>블로그 내의 모든 예시와 실습은 VMware workstation16.2.3, centos7,Moboxterm,window xp을 활용 합니다.<br>
...
![multiport사용법](../assets/img/multiport사용법.png)
...
![state예시](../assets/img/state예시.png)
...
![정책시작사용법](../assets/img/정책시작사용법.png)
